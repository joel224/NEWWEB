  ...
  return (
    <main className="w-full min-h-screen bg-[#3b0501] text-white flex flex-col items-center justify-center p-6 md:p-12 relative">
      ...
      <div className="fixed bottom-6 left-6 z-30 md:bottom-8 md:left-8">
        <Link href="/wedding">
          <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 hover:bg-white/20 border-t border-white/20 text-white/60 hover:text-white text-xs font-semibold shadow-lg transition-all cursor-pointer backdrop-blur-md">
            <FiHeart className="w-3.5 h-3.5 text-white fill-pink-300/20" />
